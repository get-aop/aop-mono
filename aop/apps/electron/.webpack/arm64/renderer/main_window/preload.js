  ...
  \************************/
    ...
    electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld("electronAPI", {
      onServerCrashed: (callback) => {
        electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.on("server-crashed", (_, code) =>
          callback(code),
        );
      },
      onServerError: (callback) => {
        electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.on("server-error", (_, error) =>
          callback(error),
        );
      },
      ...
      restartServer: () =>
        electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke("restart-server"),
    });
  })();
