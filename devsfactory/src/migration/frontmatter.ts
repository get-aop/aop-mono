/**
 * @deprecated Migration-only module for parsing markdown frontmatter from legacy files.
 * Used exclusively by the `aop migrate` command to import existing markdown files into SQLite.
